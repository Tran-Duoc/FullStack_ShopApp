...
CREATE TABLE tokens(
  id INT PRIMARY KEY AUTO_INCREMENT,
  token BIGINT(255) NOT NULL UNIQUE,
...
CREATE TABLE categories(
  id INT PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(100) NOT NULL DEFAULT '' COMMENT 'category name, ex: Đồ điện tử'
);
...
ALTER TABLE orders MODIFY COLUMN status ENUM('pending', 'processing', 'shopped', 'delivered', 'canceled') COMMENT 'order status';
